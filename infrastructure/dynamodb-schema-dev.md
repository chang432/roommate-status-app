...
| `RoommateStatus-dev-activities` | `id` (S) | — | `activities.py`, `household_checklists.py`, `household_requests.py` | Activities, checklists, requests + their comment likes (multi-type) |
