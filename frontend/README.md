...
- **Book Club**: the household page shows a two-by-two Current Book, Library,
  ...
  Meeting cards lead with a linked book title and keep the date, time, and
  reading target beneath it. Expanded cards keep attendance visible, with each
  member's own RSVP control in a stable, dedicated position.
